...
export default function Manggis() {
  ...
  if (scrollRef.current) {
    const scrollAmount = index * (400 + 20); // 400 = image width, 20 = gap-x-5
    ...
    <section className="w-full min-h-[35vh] bg-[#F3EEE7] flex flex-col items-center px-5">
            ...
            <div
             ...
             className="w-full flex flex-row justify-center items-center overflow-x-auto gap-x-5 snap-x snap-mandatory py-12 scrollbar-hidden">
                ...
                <Image
                onClick={() => setOpenMenu (openMenu === "Image1" ? null : "Image1" )} key={`1-${i}`} src="/Amankila_Resort.jpg" alt="a" width={400} height={250} className={`shrink-0 h-auto snap-start ${openMenu === "Image1" ? "absolute bg-[#F3EEE7]" : ""}`}/>
        ...
        {[...Array(9)].map((_, idx) => (
          <div
            ...
            className={`w-[25px] h-[3px] cursor-pointer transition-all ${
